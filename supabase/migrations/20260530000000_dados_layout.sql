...
COMMENT ON COLUMN pedidos.dados_layout IS 'JSON com layout do ERP do cliente preenchido pela Haiku. Estrutura: { "linhas": [ { "Nome Coluna": "valor", ... } ] }. Chaves correspondem aos nomes do layout em tenant_erp_config.mapeamento_campos.colunas[].nome_coluna.';
